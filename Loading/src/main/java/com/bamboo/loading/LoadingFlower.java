...
import com.bamboo.loading.view.FlowerView;
...
public class LoadingFlower extends LoadingBaseDialog{
    ...
    public void show() {
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (mBuilder.mDirection == LoadingConstant.DIRECT_CLOCKWISE) {
    ...
    public static class Builder {
        ...
        private int mTheme = R.style.LoadingDialog;
        ...
        private int mDirection = LoadingConstant.DIRECT_CLOCKWISE;
