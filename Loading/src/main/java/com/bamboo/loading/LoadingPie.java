...
import com.bamboo.loading.view.PieView;
 ...
 * @Author bamboolife
 * 邮箱：core_it@163.com
 * 创建时间：2020/10/31 4:53 PM
 * 描述：
 */
public class LoadingPie extends LoadingBaseDialog{
    ...
    private LoadingPie(Builder builder) {
    ...
    public void show() {
        ...
        super.show();
        if (mBuilder.mUpdateType == LoadingConstant.PIE_AUTO_UPDATE) {
    ...
    public void setPiePercentage(float percentage) {
        if (mBuilder.mUpdateType == LoadingConstant.PIE_MANUAL_UPDATE && mPieView != null) {
    ...
    public static class Builder {
        ...
        private int mUpdateType = LoadingConstant.PIE_AUTO_UPDATE;
        ...
        public LoadingPie build() {
            return new LoadingPie(this);
        }
