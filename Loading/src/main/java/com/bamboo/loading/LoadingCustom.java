...
import com.bamboo.loading.view.CustomView;
 ...
 * 描述：
 */
public class LoadingCustom extends LoadingBaseDialog{
    ...
    private LoadingCustom(Builder builder) {
    ...
    public void show() {
        if (mBuilder.mType != NO_TYPE) {
            ...
            Log.d(LoadingCustom.class.toString(), "you must assign the image source in Builder");
        }
    }
    ...
    public static class Builder {
        ...
        public LoadingCustom build() {
            return new LoadingCustom(this);
        }
